...
impl<'de> crate::serde::Deserialize<'de> for PodTemplate {
...
impl crate::serde::Serialize for PodTemplate {
...
impl crate::schemars::JsonSchema for PodTemplate {
    fn schema_name() -> String {
        "io.k8s.api.core.v1.PodTemplate".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("PodTemplate describes a template for creating copies of a predefined pod.".to_owned()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "template".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Template defines the pods that will be created from this pod template. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
