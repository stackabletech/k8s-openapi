...
impl crate::schemars::JsonSchema for RunAsGroupStrategyOptions {
    fn schema_name() -> String {
        "io.k8s.api.policy.v1beta1.RunAsGroupStrategyOptions".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("RunAsGroupStrategyOptions defines the strategy type and any options used to create the strategy.".to_owned()),
                ..Default::default()
            })),
