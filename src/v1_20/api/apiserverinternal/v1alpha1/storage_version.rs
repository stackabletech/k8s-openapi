...
pub struct StorageVersion {
    ...
    pub spec: crate::api::apiserverinternal::v1alpha1::StorageVersionSpec,
...
// Generated from operation createInternalApiserverV1alpha1StorageVersion
...
// Generated from operation deleteInternalApiserverV1alpha1CollectionStorageVersion
...
// Generated from operation deleteInternalApiserverV1alpha1StorageVersion
...
// Generated from operation listInternalApiserverV1alpha1StorageVersion
...
// Generated from operation patchInternalApiserverV1alpha1StorageVersion
...
// Generated from operation patchInternalApiserverV1alpha1StorageVersionStatus
...
// Generated from operation readInternalApiserverV1alpha1StorageVersion
...
pub enum ReadStorageVersionResponse {
    Ok(crate::api::apiserverinternal::v1alpha1::StorageVersion),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadStorageVersionResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadStorageVersionResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadStorageVersionResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation readInternalApiserverV1alpha1StorageVersionStatus
...
#[cfg(feature = "api")]
impl crate::Response for ReadStorageVersionStatusResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((ReadStorageVersionStatusResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadStorageVersionStatusResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceInternalApiserverV1alpha1StorageVersion
...
// Generated from operation replaceInternalApiserverV1alpha1StorageVersionStatus
...
// Generated from operation watchInternalApiserverV1alpha1StorageVersion
...
// End internal.apiserver.k8s.io/v1alpha1/StorageVersion
...
impl<'de> crate::serde::Deserialize<'de> for StorageVersion {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::apiserverinternal::v1alpha1::StorageVersionSpec> = None;
                let mut value_status: Option<crate::api::apiserverinternal::v1alpha1::StorageVersionStatus> = None;
...
impl crate::serde::Serialize for StorageVersion {
...
impl crate::schemars::JsonSchema for StorageVersion {
    fn schema_name() -> String {
        "io.k8s.api.apiserverinternal.v1alpha1.StorageVersion".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "metadata".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("The name is <group>.<resource>.".to_owned()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apiserverinternal::v1alpha1::StorageVersionSpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Spec is an empty spec. It is here to comply with Kubernetes API style.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apiserverinternal::v1alpha1::StorageVersionStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("API server instances report the version they can decode and the version they encode objects to when persisting objects in the backend.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
