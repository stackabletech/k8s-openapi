...
impl StatefulSet {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::apps::v1::StatefulSet,
...
pub enum ReadStatefulSetResponse {
    Ok(crate::api::apps::v1::StatefulSet),
...
impl crate::schemars::JsonSchema for StatefulSet {
    fn schema_name() -> String {
        "io.k8s.api.apps.v1.StatefulSet".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apps::v1::StatefulSetSpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Spec defines the desired identities of pods in this set.".to_owned()),
                                ..Default::default()
                            }));
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apps::v1::StatefulSetStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
