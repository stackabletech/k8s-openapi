...
impl SubjectAccessReview {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::authorization::v1beta1::SubjectAccessReview,
        ...
        let __url = "/apis/authorization.k8s.io/v1beta1/subjectaccessreviews?".to_owned();
...
impl crate::serde::Serialize for SubjectAccessReview {
...
impl crate::schemars::JsonSchema for SubjectAccessReview {
    fn schema_name() -> String {
        "io.k8s.api.authorization.v1beta1.SubjectAccessReview".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("SubjectAccessReview checks whether or not a user or group can perform an action.".to_owned()),
                ..Default::default()
            })),
