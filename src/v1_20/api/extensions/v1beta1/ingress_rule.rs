...
impl crate::schemars::JsonSchema for IngressRule {
    fn schema_name() -> String {
        "io.k8s.api.extensions.v1beta1.IngressRule".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("IngressRule represents the rules mapping the paths under a specified host to the related backend services. Incoming requests are first evaluated for a host match, then routed to the backend associated with the matching IngressRuleValue.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "http".to_owned(),
                        __gen.subschema_for::<crate::api::extensions::v1beta1::HTTPIngressRuleValue>(),
                    ),
                ].into(),
                ..Default::default()
            })),
