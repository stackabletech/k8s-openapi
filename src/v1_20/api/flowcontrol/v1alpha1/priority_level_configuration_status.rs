...
impl crate::schemars::JsonSchema for PriorityLevelConfigurationStatus {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1alpha1.PriorityLevelConfigurationStatus".to_owned()
    }
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::flowcontrol::v1alpha1::PriorityLevelConfigurationCondition>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
