...
pub struct ClusterRole {
    ...
    pub aggregation_rule: Option<crate::api::rbac::v1beta1::AggregationRule>,
...
impl ClusterRole {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::rbac::v1beta1::ClusterRole,
        ...
        let __url = "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles?".to_owned();
...
impl ClusterRole {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}",
...
/// Use `<ReadClusterRoleResponse as Response>::try_from_parts` to parse the HTTP response body of [`ClusterRole::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadClusterRoleResponse {
    Ok(crate::api::rbac::v1beta1::ClusterRole),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_aggregation_rule: Option<crate::api::rbac::v1beta1::AggregationRule> = None;
                let mut value_metadata: Option<crate::apimachinery::pkg::apis::meta::v1::ObjectMeta> = None;
                let mut value_rules: Option<Vec<crate::api::rbac::v1beta1::PolicyRule>> = None;
...
impl crate::schemars::JsonSchema for ClusterRole {
    fn schema_name() -> String {
        "io.k8s.api.rbac.v1beta1.ClusterRole".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 ClusterRole, and will no longer be served in v1.22.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::rbac::v1beta1::AggregationRule>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.".to_owned()),
                                ..Default::default()
                            }));
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Rules holds all the PolicyRules for this ClusterRole".to_owned()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(crate::schemars::schema::InstanceType::Array))),
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::rbac::v1beta1::PolicyRule>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
