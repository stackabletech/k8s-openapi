...
impl Role {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::rbac::v1beta1::Role,
        ...
        let __url = format!("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles?",
...
impl Role {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}",
...
impl Role {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/rbac.authorization.k8s.io/v1beta1/roles?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
impl Role {
    ...
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadRoleResponse`]`>` constructor, or [`ReadRoleResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadRoleResponse>), crate::RequestError> {
        let __url = format!("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadRoleResponse as Response>::try_from_parts` to parse the HTTP response body of [`Role::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadRoleResponse {
    Ok(crate::api::rbac::v1beta1::Role),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadRoleResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadRoleResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadRoleResponse::Other(result), read))
            },
        }
    }
}
...
impl crate::serde::Serialize for Role {
...
impl crate::schemars::JsonSchema for Role {
    fn schema_name() -> String {
        "io.k8s.api.rbac.v1beta1.Role".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 Role, and will no longer be served in v1.22.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Rules holds all the PolicyRules for this Role".to_owned()),
                                ..Default::default()
                            })),
