...
impl PriorityClass {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::scheduling::v1alpha1::PriorityClass,
...
pub enum ReadPriorityClassResponse {
    Ok(crate::api::scheduling::v1alpha1::PriorityClass),
...
impl crate::schemars::JsonSchema for PriorityClass {
    fn schema_name() -> String {
        "io.k8s.api.scheduling.v1alpha1.PriorityClass".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("DEPRECATED - This group version of PriorityClass is deprecated by scheduling.k8s.io/v1/PriorityClass. PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid integer.".to_owned()),
                ..Default::default()
            })),
