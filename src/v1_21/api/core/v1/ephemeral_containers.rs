...
// End /v1/EphemeralContainers

impl crate::Resource for EphemeralContainers {
...
impl<'de> crate::serde::Deserialize<'de> for EphemeralContainers {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = EphemeralContainers;
...
impl crate::serde::Serialize for EphemeralContainers {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: crate::serde::Serializer {
        ...
        crate::serde::ser::SerializeStruct::serialize_field(&mut state, "ephemeralContainers", &self.ephemeral_containers)?;
...
impl crate::schemars::JsonSchema for EphemeralContainers {
    fn schema_name() -> String {
        "io.k8s.api.core.v1.EphemeralContainers".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("A list of ephemeral containers used with the Pod ephemeralcontainers subresource.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("A list of ephemeral containers associated with this pod. New ephemeral containers may be appended to this list, but existing ephemeral containers may not be removed or modified.".to_owned()),
                                ..Default::default()
                            })),
