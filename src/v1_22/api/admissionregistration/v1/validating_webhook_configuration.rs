...
// Generated from operation createAdmissionregistrationV1ValidatingWebhookConfiguration
...
impl ValidatingWebhookConfiguration {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::admissionregistration::v1::ValidatingWebhookConfiguration,
        ...
        let __url = "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations?".to_owned();
...
// Generated from operation deleteAdmissionregistrationV1CollectionValidatingWebhookConfiguration
...
// Generated from operation deleteAdmissionregistrationV1ValidatingWebhookConfiguration
...
impl ValidatingWebhookConfiguration {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",
...
// Generated from operation listAdmissionregistrationV1ValidatingWebhookConfiguration
...
// Generated from operation patchAdmissionregistrationV1ValidatingWebhookConfiguration
...
// Generated from operation readAdmissionregistrationV1ValidatingWebhookConfiguration
...
impl ValidatingWebhookConfiguration {
    ...
    pub fn read(
        name: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadValidatingWebhookConfigurationResponse>), crate::RequestError> {
        let __url = format!("/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadValidatingWebhookConfigurationResponse as Response>::try_from_parts` to parse the HTTP response body of [`ValidatingWebhookConfiguration::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadValidatingWebhookConfigurationResponse {
    Ok(crate::api::admissionregistration::v1::ValidatingWebhookConfiguration),
...
// Generated from operation replaceAdmissionregistrationV1ValidatingWebhookConfiguration
...
// Generated from operation watchAdmissionregistrationV1ValidatingWebhookConfiguration
...
// End admissionregistration.k8s.io/v1/ValidatingWebhookConfiguration
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_webhooks: Option<Vec<crate::api::admissionregistration::v1::ValidatingWebhook>> = None;
...
impl crate::schemars::JsonSchema for ValidatingWebhookConfiguration {
    fn schema_name() -> String {
        "io.k8s.api.admissionregistration.v1.ValidatingWebhookConfiguration".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it.".to_owned()),
                ..Default::default()
            })),
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::admissionregistration::v1::ValidatingWebhook>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
