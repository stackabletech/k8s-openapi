...
impl Job {
    ...
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadJobResponse`]`>` constructor, or [`ReadJobResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadJobResponse>), crate::RequestError> {
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/jobs/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
#[cfg(feature = "api")]
impl crate::Response for ReadJobResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadJobResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadJobResponse::Other(result), read))
            },
        }
    }
}
...
impl Job {
    ...
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadJobStatusResponse`]`>` constructor, or [`ReadJobStatusResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read_status(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadJobStatusResponse>), crate::RequestError> {
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/jobs/{name}/status",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadJobStatusResponse {
    Ok(crate::api::batch::v1::Job),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadJobStatusResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((ReadJobStatusResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadJobStatusResponse::Other(result), read))
            },
        }
    }
}
...
impl<'de> crate::serde::Deserialize<'de> for Job {
...
impl crate::serde::Serialize for Job {
...
impl crate::schemars::JsonSchema for Job {
    fn schema_name() -> String {
        "io.k8s.api.batch.v1.Job".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("Job represents the configuration of a single job.".to_owned()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::batch::v1::JobStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
