...
impl crate::schemars::JsonSchema for Subject {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1beta1.Subject".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        "group".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta1::GroupSubject>().into_object();
                    ...
                    (
                        ...
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta1::ServiceAccountSubject>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                    ...
                    (
                        "user".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta1::UserSubject>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
