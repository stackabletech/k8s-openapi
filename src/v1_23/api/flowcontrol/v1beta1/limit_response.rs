...
impl crate::schemars::JsonSchema for LimitResponse {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1beta1.LimitResponse".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        "queuing".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta1::QueuingConfiguration>().into_object();
