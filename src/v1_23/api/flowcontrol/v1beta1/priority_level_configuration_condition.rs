// Generated from definition io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfigurationCondition
...
impl crate::serde::Serialize for PriorityLevelConfigurationCondition {
...
impl crate::schemars::JsonSchema for PriorityLevelConfigurationCondition {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfigurationCondition".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("PriorityLevelConfigurationCondition defines the condition of priority level.".to_owned()),
                ..Default::default()
            })),
