// Generated from definition io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationCondition
...
impl crate::schemars::JsonSchema for PriorityLevelConfigurationCondition {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationCondition".to_owned()
    }
