...
#[derive(Clone, Debug, Eq, PartialEq, value_size::Size)]
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_i64<E>(self, v: i64) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                if v < i64::from(i32::min_value()) || v > i64::from(i32::max_value()) {
                    return Err(crate::serde::de::Error::invalid_value(crate::serde::de::Unexpected::Signed(v), &"a 32-bit integer"));
                }
            ...
            fn visit_u64<E>(self, v: u64) -> Result<Self::Value, E> where E: crate::serde::de::Error {
                #[allow(clippy::cast_sign_loss)]
                {
                    if v > i32::max_value() as u64 {
                        return Err(crate::serde::de::Error::invalid_value(crate::serde::de::Unexpected::Unsigned(v), &"a 32-bit integer"));
                    }
                }
