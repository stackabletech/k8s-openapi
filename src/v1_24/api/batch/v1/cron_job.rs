...
pub struct CronJob {
    ...
    pub spec: Option<crate::api::batch::v1::CronJobSpec>,
...
// Generated from operation createBatchV1NamespacedCronJob
...
impl CronJob {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::batch::v1::CronJob,
        ...
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/cronjobs?",
...
// Generated from operation deleteBatchV1CollectionNamespacedCronJob
...
// Generated from operation deleteBatchV1NamespacedCronJob
...
impl CronJob {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}",
...
// Generated from operation listBatchV1CronJobForAllNamespaces
...
impl CronJob {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/batch/v1/cronjobs?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation listBatchV1NamespacedCronJob
...
// Generated from operation patchBatchV1NamespacedCronJob
...
// Generated from operation patchBatchV1NamespacedCronJobStatus
...
impl CronJob {
    ...
    pub fn patch_status(
        ...
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status?",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
...
// Generated from operation readBatchV1NamespacedCronJob
...
impl CronJob {
    ...
    pub fn read(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadCronJobResponse>), crate::RequestError> {
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadCronJobResponse {
    Ok(crate::api::batch::v1::CronJob),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadCronJobResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadCronJobResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadCronJobResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation readBatchV1NamespacedCronJobStatus
...
impl CronJob {
    ...
    pub fn read_status(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadCronJobStatusResponse>), crate::RequestError> {
        let __url = format!("/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadCronJobStatusResponse {
    Ok(crate::api::batch::v1::CronJob),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadCronJobStatusResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((ReadCronJobStatusResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadCronJobStatusResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceBatchV1NamespacedCronJob
...
// Generated from operation replaceBatchV1NamespacedCronJobStatus
...
// Generated from operation watchBatchV1CronJobForAllNamespaces
...
// Generated from operation watchBatchV1NamespacedCronJob
...
impl crate::DeepMerge for CronJob {
...
impl<'de> crate::serde::Deserialize<'de> for CronJob {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::batch::v1::CronJobSpec> = None;
                let mut value_status: Option<crate::api::batch::v1::CronJobStatus> = None;
...
impl crate::serde::Serialize for CronJob {
...
impl crate::schemars::JsonSchema for CronJob {
    fn schema_name() -> String {
        "io.k8s.api.batch.v1.CronJob".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("CronJob represents the configuration of a single cron job.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::batch::v1::CronJobSpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::batch::v1::CronJobStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
