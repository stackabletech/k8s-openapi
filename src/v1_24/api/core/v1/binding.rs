...
impl<'de> crate::serde::Deserialize<'de> for Binding {
...
impl crate::serde::Serialize for Binding {
...
impl crate::schemars::JsonSchema for Binding {
    fn schema_name() -> String {
        "io.k8s.api.core.v1.Binding".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("Binding ties one object to another; for example, a pod is bound to a node by a scheduler. Deprecated in 1.7, please use the bindings subresource of pods instead.".to_owned()),
                ..Default::default()
            })),
                ...
                properties: [
                    ...
                    (
                        "target".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("The target object that you want to bind to the standard object.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
