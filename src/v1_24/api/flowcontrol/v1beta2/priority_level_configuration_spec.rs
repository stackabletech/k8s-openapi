// Generated from definition io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec

/// PriorityLevelConfigurationSpec specifies the configuration of a priority level.
#[derive(Clone, Debug, Default, PartialEq, value_size::Size)]
pub struct PriorityLevelConfigurationSpec {
    /// `limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `"Limited"`.
    pub limited: Option<crate::api::flowcontrol::v1beta2::LimitedPriorityLevelConfiguration>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                let mut value_limited: Option<crate::api::flowcontrol::v1beta2::LimitedPriorityLevelConfiguration> = None;
...
impl crate::schemars::JsonSchema for PriorityLevelConfigurationSpec {
    fn schema_name() -> String {
        "io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        "limited".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::flowcontrol::v1beta2::LimitedPriorityLevelConfiguration>().into_object();
