...
pub struct NetworkPolicy {
    ...
    pub status: Option<crate::api::networking::v1::NetworkPolicyStatus>,
}
...
impl NetworkPolicy {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::networking::v1::NetworkPolicy,
...
impl NetworkPolicy {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/networking.k8s.io/v1/networkpolicies?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation patchNetworkingV1NamespacedNetworkPolicyStatus
...
impl NetworkPolicy {
    ...
    pub fn patch_status(
        ...
        let __url = format!("/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}/status?",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
...
pub enum ReadNetworkPolicyResponse {
    Ok(crate::api::networking::v1::NetworkPolicy),
...
// Generated from operation readNetworkingV1NamespacedNetworkPolicyStatus

impl NetworkPolicy {
    /// read status of the specified NetworkPolicy
    ///
    /// Use the returned [`crate::ResponseBody`]`<`[`ReadNetworkPolicyStatusResponse`]`>` constructor, or [`ReadNetworkPolicyStatusResponse`] directly, to parse the HTTP response.
    ///
    /// # Arguments
    ///
    /// * `name`
    ...
    pub fn read_status(
        name: &str,
        namespace: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadNetworkPolicyStatusResponse>), crate::RequestError> {
        let __url = format!("/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}/status",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
            namespace = crate::percent_encoding::percent_encode(namespace.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadNetworkPolicyStatusResponse as Response>::try_from_parts` to parse the HTTP response body of [`NetworkPolicy::read_status`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadNetworkPolicyStatusResponse {
    Ok(crate::api::networking::v1::NetworkPolicy),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadNetworkPolicyStatusResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                let result = match crate::serde_json::from_slice(buf) {
                ...
                Ok((ReadNetworkPolicyStatusResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadNetworkPolicyStatusResponse::Other(result), read))
            },
        }
    }
}
...
// Generated from operation replaceNetworkingV1NamespacedNetworkPolicyStatus
...
impl<'de> crate::serde::Deserialize<'de> for NetworkPolicy {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::networking::v1::NetworkPolicySpec> = None;
                let mut value_status: Option<crate::api::networking::v1::NetworkPolicyStatus> = None;
...
impl crate::serde::Serialize for NetworkPolicy {
...
impl crate::schemars::JsonSchema for NetworkPolicy {
    fn schema_name() -> String {
        "io.k8s.api.networking.v1.NetworkPolicy".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("NetworkPolicy describes what network traffic is allowed for a set of Pods".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::NetworkPolicySpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Specification of the desired behavior for this NetworkPolicy.".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::networking::v1::NetworkPolicyStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Status is the current state of the NetworkPolicy. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
