...
impl ClusterRoleBinding {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::rbac::v1::ClusterRoleBinding,
...
/// Use `<ReadClusterRoleBindingResponse as Response>::try_from_parts` to parse the HTTP response body of [`ClusterRoleBinding::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadClusterRoleBindingResponse {
    Ok(crate::api::rbac::v1::ClusterRoleBinding),
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_subjects: Option<Vec<crate::api::rbac::v1::Subject>> = None;
...
impl crate::schemars::JsonSchema for ClusterRoleBinding {
    fn schema_name() -> String {
        "io.k8s.api.rbac.v1.ClusterRoleBinding".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("ClusterRoleBinding references a ClusterRole, but not contain it.  It can reference a ClusterRole in the global namespace, and adds who information via Subject.".to_owned()),
                ..Default::default()
            })),
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::rbac::v1::Subject>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
