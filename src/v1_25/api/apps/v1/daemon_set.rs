...
pub struct DaemonSet {
    ...
    pub spec: Option<crate::api::apps::v1::DaemonSetSpec>,

    /// The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    pub status: Option<crate::api::apps::v1::DaemonSetStatus>,
}


// Begin apps/v1/DaemonSet

// Generated from operation createAppsV1NamespacedDaemonSet
...
impl DaemonSet {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::apps::v1::DaemonSet,
        ...
        let __url = format!("/apis/apps/v1/namespaces/{namespace}/daemonsets?",
...
// Generated from operation deleteAppsV1CollectionNamespacedDaemonSet
...
// Generated from operation deleteAppsV1NamespacedDaemonSet
...
// Generated from operation listAppsV1DaemonSetForAllNamespaces
...
impl DaemonSet {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/apps/v1/daemonsets?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation listAppsV1NamespacedDaemonSet
...
// Generated from operation patchAppsV1NamespacedDaemonSet
...
// Generated from operation patchAppsV1NamespacedDaemonSetStatus
...
// Generated from operation readAppsV1NamespacedDaemonSet
...
pub enum ReadDaemonSetResponse {
    Ok(crate::api::apps::v1::DaemonSet),
...
// Generated from operation readAppsV1NamespacedDaemonSetStatus
...
// Generated from operation replaceAppsV1NamespacedDaemonSet
...
// Generated from operation replaceAppsV1NamespacedDaemonSetStatus
...
// Generated from operation watchAppsV1DaemonSetForAllNamespaces
...
// Generated from operation watchAppsV1NamespacedDaemonSet
...
impl crate::DeepMerge for DaemonSet {
...
impl<'de> crate::serde::Deserialize<'de> for DaemonSet {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::apps::v1::DaemonSetSpec> = None;
                let mut value_status: Option<crate::api::apps::v1::DaemonSetStatus> = None;
...
impl crate::serde::Serialize for DaemonSet {
...
impl crate::schemars::JsonSchema for DaemonSet {
    fn schema_name() -> String {
        "io.k8s.api.apps.v1.DaemonSet".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("DaemonSet represents the configuration of a daemon set.".to_owned()),
                ..Default::default()
            })),
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apps::v1::DaemonSetSpec>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
                    ...
                    (
                        "status".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::apps::v1::DaemonSetStatus>().into_object();
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
