...
impl crate::schemars::JsonSchema for ContainerResourceMetricStatus {
    fn schema_name() -> String {
        "io.k8s.api.autoscaling.v2beta2.ContainerResourceMetricStatus".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    ...
                    (
                        "current".to_owned(),
                        {
                            let mut schema_obj = __gen.subschema_for::<crate::api::autoscaling::v2beta2::MetricValueStatus>().into_object();
