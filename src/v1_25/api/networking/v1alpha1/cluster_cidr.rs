...
// Begin networking.k8s.io/v1alpha1/ClusterCIDR

// Generated from operation createNetworkingV1alpha1ClusterCIDR
...
impl ClusterCIDR {
    ...
    #[cfg(feature = "api")]
    pub fn create(
        body: &crate::api::networking::v1alpha1::ClusterCIDR,
        ...
        let __url = "/apis/networking.k8s.io/v1alpha1/clustercidrs?".to_owned();
...
// Generated from operation deleteNetworkingV1alpha1ClusterCIDR
...
impl ClusterCIDR {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",
...
// Generated from operation deleteNetworkingV1alpha1CollectionClusterCIDR
...
// Generated from operation listNetworkingV1alpha1ClusterCIDR
...
// Generated from operation patchNetworkingV1alpha1ClusterCIDR
...
// Generated from operation readNetworkingV1alpha1ClusterCIDR
...
impl ClusterCIDR {
    ...
    pub fn read(
        name: &str,
    ) -> Result<(crate::http::Request<Vec<u8>>, fn(crate::http::StatusCode) -> crate::ResponseBody<ReadClusterCIDRResponse>), crate::RequestError> {
        let __url = format!("/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",
            name = crate::percent_encoding::percent_encode(name.as_bytes(), crate::percent_encoding2::PATH_SEGMENT_ENCODE_SET),
        );
...
/// Use `<ReadClusterCIDRResponse as Response>::try_from_parts` to parse the HTTP response body of [`ClusterCIDR::read`]
#[cfg(feature = "api")]
#[derive(Debug)]
pub enum ReadClusterCIDRResponse {
    Ok(crate::api::networking::v1alpha1::ClusterCIDR),
    Other(Result<Option<crate::serde_json::Value>, crate::serde_json::Error>),
}

#[cfg(feature = "api")]
impl crate::Response for ReadClusterCIDRResponse {
    fn try_from_parts(status_code: crate::http::StatusCode, buf: &[u8]) -> Result<(Self, usize), crate::ResponseError> {
        match status_code {
            crate::http::StatusCode::OK => {
                ...
                Ok((ReadClusterCIDRResponse::Ok(result), buf.len()))
            },
            _ => {
                let (result, read) =
                    if buf.is_empty() {
                ...
                Ok((ReadClusterCIDRResponse::Other(result), read))
            },
        }
    }
}

// Generated from operation replaceNetworkingV1alpha1ClusterCIDR
...
// Generated from operation watchNetworkingV1alpha1ClusterCIDR
...
// End networking.k8s.io/v1alpha1/ClusterCIDR
                ...
                properties: [
                    ...
                    (
                        "spec".to_owned(),
                        {
                            ...
                            schema_obj.metadata = Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Spec is the desired state of the ClusterCIDR. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status".to_owned()),
                                ..Default::default()
                            }));
                            crate::schemars::schema::Schema::Object(schema_obj)
                        },
