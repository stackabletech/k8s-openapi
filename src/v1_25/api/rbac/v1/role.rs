...
impl Role {
    ...
    pub fn create(
        ...
        let __url = format!("/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles?",
...
impl Role {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",
...
impl crate::schemars::JsonSchema for Role {
    fn schema_name() -> String {
        "io.k8s.api.rbac.v1.Role".to_owned()
    }

    fn json_schema(__gen: &mut crate::schemars::gen::SchemaGenerator) -> crate::schemars::schema::Schema {
        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                description: Some("Role is a namespaced, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding.".to_owned()),
                ..Default::default()
            })),
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            ...
                            array: Some(Box::new(crate::schemars::schema::ArrayValidation {
                                items: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(__gen.subschema_for::<crate::api::rbac::v1::PolicyRule>()))),
                                ..Default::default()
                            })),
                            ..Default::default()
                        }),
