// Generated from definition io.k8s.api.storage.v1beta1.CSIStorageCapacity
...
// Generated from operation createStorageV1beta1NamespacedCSIStorageCapacity
...
impl CSIStorageCapacity {
    ...
    pub fn create(
        namespace: &str,
        body: &crate::api::storage::v1beta1::CSIStorageCapacity,
        ...
        let __url = format!("/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities?",
...
// Generated from operation deleteStorageV1beta1CollectionNamespacedCSIStorageCapacity
...
// Generated from operation deleteStorageV1beta1NamespacedCSIStorageCapacity
...
impl CSIStorageCapacity {
    ...
    pub fn delete(
        ...
        let __url = format!("/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}",
...
// Generated from operation listStorageV1beta1CSIStorageCapacityForAllNamespaces
...
impl CSIStorageCapacity {
    ...
    pub fn list_for_all_namespaces(
        ...
        let __url = "/apis/storage.k8s.io/v1beta1/csistoragecapacities?".to_owned();
        let mut __query_pairs = crate::url::form_urlencoded::Serializer::new(__url);
        optional.__serialize(&mut __query_pairs);
        let __url = __query_pairs.finish();
...
// Generated from operation listStorageV1beta1NamespacedCSIStorageCapacity
...
// Generated from operation patchStorageV1beta1NamespacedCSIStorageCapacity
...
// Generated from operation readStorageV1beta1NamespacedCSIStorageCapacity
...
pub enum ReadCSIStorageCapacityResponse {
    Ok(crate::api::storage::v1beta1::CSIStorageCapacity),
...
// Generated from operation replaceStorageV1beta1NamespacedCSIStorageCapacity
...
// Generated from operation watchStorageV1beta1CSIStorageCapacityForAllNamespaces
...
// Generated from operation watchStorageV1beta1NamespacedCSIStorageCapacity
...
// End storage.k8s.io/v1beta1/CSIStorageCapacity
...
impl crate::schemars::JsonSchema for CSIStorageCapacity {
    fn schema_name() -> String {
        "io.k8s.api.storage.v1beta1.CSIStorageCapacity".to_owned()
    }
